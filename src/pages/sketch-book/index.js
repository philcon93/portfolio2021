import { Intro, Posts, PageWrapper } from "../../components/site";
        ...
        <Intro
          ...
          subtitle={
            <>
              ...
              term, it gives a means to &apos;sketch&apos; ideas in code.
            </>
          }
        />
        {sketches.length > 0 && (
          <Posts directory="sketch-book" posts={sketches} />
        )}
      </PageWrapper>
    </>
  );
...
export async function getStaticProps() {
  const sketches = getAllPosts(
    ["date", "excerpt", "title", "slug", "tags", "external", "url"],
    sketchesDirectory
  );
